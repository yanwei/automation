...
2020-02-05, yanwei, replace pip3 with 'python3 -m pip'
"""
...
package_list = json.loads(
    os.popen('python3 -m pip list --outdated --format json').readlines()[0])

updated_packages = []

for package in package_list:
    os.system('python3 -m pip install -U ' + package['name'])
